...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_2eproto = {
    &descriptor_table_test_2eproto_initialized,
    descriptor_table_protodef_test_2eproto,
    "test.proto",
    578,
    &descriptor_table_test_2eproto_once,
    descriptor_table_test_2eproto_sccs,
...
#undef CHK_
  ...
  void LoginResponse::SharedCtor()
  {
    ...
    ::memset(&result_, 0, static_cast<size_t>(reinterpret_cast<char *>(&success_) - reinterpret_cast<char *>(&result_)) + sizeof(success_));
  }
...
#undef CHK_
  ...
  void User::SharedCtor()
  {
    ...
    name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
    ::memset(&age_, 0, static_cast<size_t>(reinterpret_cast<char *>(&sex_) - reinterpret_cast<char *>(&age_)) + sizeof(sex_));
  }
...
#undef CHK_
      ...
      ::PROTOBUF_NAMESPACE_ID::uint8 *target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream *stream) const
  {
    ...
    for (unsigned int i = 0,
                      n = static_cast<unsigned int>(this->_internal_friend_list_size());
         i < n; i++)
    {
      target = stream->EnsureSpace(target);
      target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
...
template <>
PROTOBUF_NOINLINE ::fixbug::LoginRequest *Arena::CreateMaybeMessage<::fixbug::LoginRequest>(Arena *arena)
{
  return Arena::CreateInternal<::fixbug::LoginRequest>(arena);
}
template <>
PROTOBUF_NOINLINE ::fixbug::LoginResponse *Arena::CreateMaybeMessage<::fixbug::LoginResponse>(Arena *arena)
{
  return Arena::CreateInternal<::fixbug::LoginResponse>(arena);
}
template <>
PROTOBUF_NOINLINE ::fixbug::GetFriendListsRequest *Arena::CreateMaybeMessage<::fixbug::GetFriendListsRequest>(Arena *arena)
{
  return Arena::CreateInternal<::fixbug::GetFriendListsRequest>(arena);
}
template <>
PROTOBUF_NOINLINE ::fixbug::User *Arena::CreateMaybeMessage<::fixbug::User>(Arena *arena)
{
  return Arena::CreateInternal<::fixbug::User>(arena);
}
template <>
PROTOBUF_NOINLINE ::fixbug::GetFriendListsResponse *Arena::CreateMaybeMessage<::fixbug::GetFriendListsResponse>(Arena *arena)
{
